public class BankAccount3{ 
	...
	*/
	public BankAccount3() throws Exception{
		this(0);
	}
	...
	*/
	public BankAccount3(double anyInitialBalance) throws Exception{
		if (anyInitialBalance <0){
			throw new Exception("Initial Deposit Amount can not be negative");
		}
	...
	* @param anyAmount The deposit amount.
     * @exception Exception When the deposit amount is negative
	*/ 
	public void deposit(double anyAmount) throws Exception{
		if (anyAmount <0){
	...
	*/ 
	public void withdrawal(double anyAmount) throws Exception{
		if (anyAmount <0){
