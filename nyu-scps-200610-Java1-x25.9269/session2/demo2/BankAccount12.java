...
{ 
	...
	private static final int firstAccountNumber =10234;

	/** Static final  integer field to hold the first account number. */
	// we still want to keep the value as our little secret - private.
	public static final int DEFAULT_INTEREST_RATE =4;
	...
	*/
	public BankAccount12(double anyInitialBalance){
		System.out.println("\tIn BankAccount12(double anyInitialBalance) Constructor");
