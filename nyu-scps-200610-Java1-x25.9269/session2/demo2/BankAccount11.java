...
{ 
	...
	/** Static integer field to hold the first account number. */
	private static int firstAccountNumber =10234;
	...
	*/
	public static int getNumberOfAccountsOpened(){
		...
		return nextAccountNumber - firstAccountNumber ;
	}

	/** A constructor that assigns an account number to a bank account. 
	*/
	public BankAccount11(){
	...
	*/
	public BankAccount11(double anyInitialBalance){
		System.out.println("\tIn BankAccount11(double anyInitialBalance) Constructor");
