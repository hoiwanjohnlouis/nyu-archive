...
public class DocAttachmentReceiver{

	private static final Logger logger = Logger.getLogger(DocAttachmentReceiver.class);

    public static void main(String[] args){
        String to ="http://localhost:8080/servlet/StockQuoteWithDocAttachmentProviderServlet";
            ...
            if (reply != null) {
                ...
                while (iterator.hasNext()) {
                    ...
                    if (!(type.equals("text/plain"))){
    	                ...
    	                FileOutputStream os = new FileOutputStream("\\"+id);
    	                dataHandler.writeTo(os);
    	                logger.debug("Attachment id: " + id );
    	                logger.debug("Please check Attachment in: " + "\\"+id );                    	
                    }
                    else{
