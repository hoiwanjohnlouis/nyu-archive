...
public class StockQuoteWithTextAttachmentProviderServlet extends HttpServlet{
	
	private static final Logger logger = Logger.getLogger(StockQuoteWithTextAttachmentProviderServlet.class);
    ...
    public void doPost( HttpServletRequest req, HttpServletResponse resp) throws ServletException{
	  ...
	  String symbol=null;
        try {
            ...
            logger.info("Adding text attachment");
            String content = "This is not an offer (or solicitation of an offer) " +
            					"to buy/sell the securities/instruments " +
            ...
            attachment.setContentId("Disclaimer");
