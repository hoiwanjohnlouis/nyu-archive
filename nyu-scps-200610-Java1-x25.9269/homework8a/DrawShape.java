...
public class DrawShape extends Frame
{
    ...
    */
    public DrawShape()
    {
        ...
        addWindowListener(new DrawShape.InnerWindowListener());
        ...
        addMouseListener(new DrawShape.InnerMouseListener());

        // add an instance of inner mouse motion listener.
        addMouseMotionListener(new DrawShape.InnerMouseMotionListener());
