...
public class RemoveItemFromShoppingCartServlet extends HttpServlet
{
    private static final Logger logger = Logger.getLogger(RemoveItemFromShoppingCartServlet.class);
        ...
        throws ServletException, IOException
    {
        ...
        try{
            ...
            if (!(found))
            {
                ...
                out.println("<H3>Sorry, could not remove from shopping cart</H3>");
                return;
            }
            ...
            if (shoppingcart==null)
            {
                ...
                out.println("<H3>Sorry, cannot remove item " + id + ", your shopping cart is empty</H3>");
            }
            else {
