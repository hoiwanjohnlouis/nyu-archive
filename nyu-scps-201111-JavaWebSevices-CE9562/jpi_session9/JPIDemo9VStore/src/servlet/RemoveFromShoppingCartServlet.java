...
public class RemoveFromShoppingCartServlet extends HttpServlet {
  ...
  private static final Logger logger = Logger.getLogger(RemoveFromShoppingCartServlet.class);
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    if ((id!=0) && (price!=0) && (type!=null)){
      cart.delete(id, type, price);
      logger.debug(caller + "deleted id: " + id + " type: " + type + " price: " + price);
    }
    else{
      logger.debug(caller + "can not delete id: " + id + " type: " + type + " price: " + price);
    }
